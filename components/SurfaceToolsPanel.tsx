  ...
  return (
    <section className="rounded-2xl border border-slate-800 bg-slate-900/70 px-3 py-3 text-xs space-y-2">
      ...
      <p className="text-[11px] text-slate-400">
        Repaint walls in a listing-friendly neutral and swap flooring for a few
        high-impact presets.
      </p>
      ...
      <div className="space-y-2">
        ...
        <div className="space-y-1">
          ...
          <select
            ...
            onChange={(e) =>
              onChangeFlooringPreset(
                e.target.value as FlooringPreset
              )
            }
          ...
          <p className="text-[10px] text-slate-500 mt-0.5">
            Floor updates keep perspective and layout, just swap materials.
          </p>
        </div>
      </div>
    </section>
