 ...
 * Geometry edge = AFC_V2_RUNTIME_CUBE_EDGE_M; wrapper scale = 1; floor at Y = 0.
 */
const TEST_CUBE_HALF_EDGE_M = AFC_V2_RUNTIME_CUBE_EDGE_M / 2;
export const TEST_CUBE_PLACEMENT_LOCAL_AABB: LocalAabb = Object.freeze({
  ...
  max: Object.freeze({ x: TEST_CUBE_HALF_EDGE_M, y: AFC_V2_RUNTIME_CUBE_EDGE_M, z: TEST_CUBE_HALF_EDGE_M }),
});
