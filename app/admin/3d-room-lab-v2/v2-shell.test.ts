...
test("v2 browser runtime remains isolated from v1 UI and research", () => {
  ...
  const allowedImports = new Set([
    ...
    "./explicit-gemini-floor-wall-trust",
    ...
    "./metric-room-prior-contract",
    "./metric-correspondence-span-contract",
    "./metric-correspondence-span",
    "./metric-correspondence-estimate-contract",
    "./metric-correspondence-estimate-acceptance",
    "./metric-auto-scale-contract",
    "./metric-auto-scale",
    "./metric-lab-ux",
    "./observed-span-metric-candidate-contract",
    "./observed-span-metric-candidate",
    "./observed-span-physical-estimate-contract",
    "./observed-span-physical-estimate-acceptance",
    "./observed-span-auto-metric-scale",
